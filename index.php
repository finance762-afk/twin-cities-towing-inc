...
<section class="hero hero-kenburns"
  ...
  <div class="hero-content">
    ...
    <div class="hero-eyebrow">
      <i data-lucide="shield-check" style="width:14px;height:14px;display:inline-block;vertical-align:middle;margin-right:6px;"></i>
      Serving Richmond, TX Since <?php echo $yearEstablished; ?>
    </div>

    <h1 class="hero-title" id="hero-heading">
      Stuck in Richmond?<br>We&rsquo;re Already On the Way.
    </h1>
    ...
    <div class="hero-trust">
      <div class="hero-trust-item">
        <i data-lucide="shield" style="width:15px;height:15px;color:var(--color-accent);"></i>
        Licensed &amp; Insured
      </div>
      <div class="hero-trust-item">
        <i data-lucide="calendar" style="width:15px;height:15px;color:var(--color-accent);"></i>
        <?php echo $yearsInBusiness; ?>+ Years Local
      </div>
      <div class="hero-trust-item">
        <i data-lucide="clock" style="width:15px;height:15px;color:var(--color-accent);"></i>
        24/7 Always Available
      </div>
      <div class="hero-trust-item">
        <i data-lucide="star" style="width:15px;height:15px;color:var(--color-accent);"></i>
        4.9&#9733; Google Rating
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="about-split-home">
      ...
      <div class="about-left" data-animate="fade-up">
        ...
        <span class="eyebrow">
          <i data-lucide="users" style="width:13px;height:13px;vertical-align:middle;margin-right:5px;"></i>
          Who We Are
        </span>
...
<section class="reviews-section numbered-section" data-num="03" id="reviews">
  <div class="container">
    ...
    <div class="section-header" data-animate="fade-up">
      <span class="eyebrow" style="color:rgba(255,255,255,0.5);">
        <i data-lucide="star" style="width:13px;height:13px;vertical-align:middle;margin-right:5px;"></i>
        What Customers Say
      </span>
      <h2>4.9 Stars Across Fort Bend County</h2>
      <p>Real drivers. Real breakdowns. Real results &mdash; from Richmond to Katy and everywhere in between.</p>
    </div>
...
<section class="numbered-section section-light" data-num="04" style="padding: var(--space-16) 0;" id="faq">
  <div class="container">
    ...
    <div class="section-header" data-animate="fade-up">
      <span class="eyebrow">
        <i data-lucide="help-circle" style="width:13px;height:13px;vertical-align:middle;margin-right:5px;"></i>
        Common Questions
      </span>
      <h2>Towing Questions — Answered Straight</h2>
      <p>No fluff. Here&rsquo;s what most Richmond-area drivers ask before they call us.</p>
    </div>
